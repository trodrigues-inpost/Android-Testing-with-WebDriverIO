...
class Selectors {
    ...
    static get checkoutContinueButton() {
    ...
    static get checkoutFinishButton() {
        return '//android.view.ViewGroup[@content-desc="test-FINISH"]';
    }
    static get backHome() {
        return '//android.view.ViewGroup[@content-desc="test-BACK HOME"]';
    }

    static get toggleViewButton() {
        return '//android.view.ViewGroup[@content-desc="test-Toggle"]/android.widget.ImageView';
    }

    // Error Messages
    static get errorMessage() {
        return '//android.view.ViewGroup[@content-desc="test-Error message"]';
    }

    // Uncategorized
    static get priceElements() {
        return '//android.widget.TextView[@content-desc="test-Price"]';
    }
    static get emptyCartTitle() {
        return '//android.widget.TextView[@text="Your cart is empty"]';
    }
    static get yourCartTitle() {
    ...
    static get productsPage() {
        return '~test-PRODUCTS';
    }

    // Indexed XPaths, these need parameters
    static itemTitle(num = 1) {
